                                    ...
                                    <Popup trigger={showPopup} setTrigger={setShowPopup}>
                                        <div className={cx('popup-content')}>
                                            ...
                                            <div className={cx('StepShelving')}>
                                                <button className={cx('ButtonShelving')}>Dự định đọc</button>
                                ...
                                <div id="RS" className={cx('RatingStats')}>
                                    <div className={cx('Rating')}>
                                        <Rate
                                            allowHalf
                                            disabled
                                            defaultValue={book.rating?.averageRating}
                                            style={{ fontSize: 36 }}
                                        />
                                    </div>
                                    <div>
                            ...
                            <div className={cx('Communicate')}>
                                ...
                                <div className={cx('HistogramBar')}>
                                    ...
                                    <div className={cx('ProgressBar')}>
                                        <Progress
                                            percent={
                                                book.rating?.ratingCount > 0
                                                    ? (book.rating?.fiveStar / book.rating?.ratingCount) * 100
                                                    : 0
                                            }
                                            size="big"
                                            status="active"
                                ...
                                <div className={cx('HistogramBar')}>
                                    ...
                                    <div className={cx('ProgressBar')}>
                                        <Progress
                                            percent={
                                                book.rating?.ratingCount > 0
                                                    ? (book.rating?.fourStar / book.rating?.ratingCount) * 100
                                                    : 0
                                            }
                                            size="big"
                                            status="active"
                                ...
                                <div className={cx('HistogramBar')}>
                                    ...
                                    <div className={cx('ProgressBar')}>
                                        <Progress
                                            percent={
                                                book.rating?.ratingCount > 0
                                                    ? (book.rating?.threeStar / book.rating?.ratingCount) * 100
                                                    : 0
                                            }
                                            size="big"
                                            status="active"
                                ...
                                <div className={cx('HistogramBar')}>
                                    ...
                                    <div className={cx('ProgressBar')}>
                                        <Progress
                                            percent={
                                                book.rating?.ratingCount > 0
                                                    ? (book.rating?.twoStar / book.rating?.ratingCount) * 100
                                                    : 0
                                            }
                                            size="big"
                                            status="active"
                                ...
                                <div className={cx('HistogramBar')}>
                                    ...
                                    <div className={cx('ProgressBar')}>
                                        <Progress
                                            percent={
                                                book.rating?.ratingCount > 0
                                                    ? (book.rating?.oneStar / book.rating?.ratingCount) * 100
                                                    : 0
                                            }
                                            size="big"
                                            status="active"
